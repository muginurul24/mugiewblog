...
**Status:** 🟢 Completed | **Priority:** P0 (MVP Blocker — Comments, SEO, Notifications), P1 (Newsletter)  
...
- [x] Comments display nested up to 3 levels
- [x] New comments from new users go to moderation
- [x] CommentCreated event fires on new comment
- [x] Spam patterns detected and auto-flagged
...
**Acceptance Criteria:**
- [x] Notifications appear in Filament bell icon (polling every 20s)
- [x] Unread count badge live-updates
- [x] Author clicks notification → redirects to article
- [x] Admin/editor sees "comment needs moderation" bell notification
- [x] All notifications dispatched via ShouldQueue
- [x] Comment author gets notification when comment approved
- [x] Email sent to article author for new comment (queued)
...
**Acceptance Criteria:**
- [x] Search returns relevant results for tech keywords
- [x] Partial matches work (e.g., "pipe" finds "Pipe Operator")
- [x] Results display highlighted keywords in excerpt
...
**Acceptance Criteria:**
- [x] Every article page has complete OG + Twitter Card tags
- [x] Article schema validates in Google Rich Results Test
- [x] sitemap.xml is accessible and lists all published articles
- [x] robots.txt points to sitemap
- [x] RSS feed validates in W3C Feed Validator
...
- [x] Subscribe form visible in footer or sidebar
- [x] Double opt-in email sent on subscribe
- [x] Unsubscribe endpoint functional

---

**Epic Completion Criteria:**
- [x] Comment system fully functional with moderation
- [x] Database notifications working via Filament bell (20s polling)
- [x] Email notifications queued for comment replies
- [x] MySQL search returns relevant results
- [x] SEO metadata present on all pages
- [x] Sitemap, robots.txt, RSS feed accessible
